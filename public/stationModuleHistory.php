...
//
function qruqsp_core_stationModuleHistory($qruqsp) {
    //
    ...
    $rc = qruqsp_core_checkAccess($qruqsp, $args['station_id'], 'qruqsp.core.stationModuleHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return qruqsp_core_dbGetModuleHistory($qruqsp, 'qruqsp.core', 'qruqsp_core_history', $args['station_id'], 
        'qruqsp_core_station_modules', $args['field'], 'status');
}
?>
