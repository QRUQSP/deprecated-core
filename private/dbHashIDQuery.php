...
//
// This function was developed to support qruqsp_imports_autoMerge.
//
// Arguments
// ---------
// qruqsp:          
...
//
function qruqsp_core_dbHashIDQuery(&$q, $strsql, $module, $container_name, $col_name) {
    //
    ...
    if( $result == false ) {
        ...
        return array('stat'=>'fail', 'err'=>array('code'=>'qruqsp.core.81', 'msg'=>'Database Error', 'pmsg'=>mysqli_error($dh)));
    }
