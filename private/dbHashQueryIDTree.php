...
//
function qruqsp_core_dbHashQueryIDTree(&$q, $strsql, $module, $tree) {
    //
    ...
    if( $result == false ) {
        ...
        return array('stat'=>'fail', 'err'=>array('code'=>'qruqsp.core.31', 'msg'=>'Database Error', 'pmsg'=>mysqli_error($dh)));
    }
